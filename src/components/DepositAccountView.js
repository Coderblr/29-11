...
export default function DepositAccountView() {
    ...
    const handleSubmit = async (event) => {
        ...
        try {
            ...
            // Add to history
            addToHistory('Deposit Account', {
                count: parseInt(no_acc, 10),
                region: region,
                cif: cif,
                details: `${parseInt(no_acc, 10)} Deposit Account(s) created for CIF ${cif}`
            });
        } catch (err) {
        ...
        <div>
            <div style={styles.pageHeader}>
                <div>
                    ...
                    <p style={styles.pageSubtitle}>Generate deposit accounts for testing</p>
                </div>
            </div>
