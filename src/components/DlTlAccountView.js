...
export default function DlTlAccountView() {
    ...
    const handleSubmit = async (event) => {
        ...
        const url = `http://10.1.161.199:5050/create_dltl/`;
        ...
        try {
            ...
            // Add to history
            addToHistory('DL-TL Account', {
                count: parseInt(no_acc, 10),
                region: region,
                cif: cif,
                details: `${parseInt(no_acc, 10)} DL-TL Account(s) created for CIF ${cif}`
            });
        } catch (err) {
    ...
    const downloadCsv = () => {
        ...
        link.setAttribute("download", "dltl_account_data.csv");
    ...
    return (
        <div>
            <div style={styles.pageHeader}>
                <div>
                    <h1 style={styles.pageTitle}>Create DL-TL Account</h1>
                    <p style={styles.pageSubtitle}>Generate DL-TL accounts for testing</p>
                </div>
            </div>
