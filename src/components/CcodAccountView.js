...
export default function CcodAccountView() {
    ...
    const handleSubmit = async (event) => {
        ...
        try {
            ...
            // Add to history
            addToHistory('CCOD Account', {
                count: parseInt(no_acc, 10),
                region: region,
                cif: cif,
                details: `${parseInt(no_acc, 10)} CCOD Account(s) created for CIF ${cif}`
            });
        } catch (err) {
        ...
        <div>
            <div style={styles.pageHeader}>
                <div>
                    ...
                    <p style={styles.pageSubtitle}>Generate CCOD accounts for testing</p>
                </div>
            </div>
